...
namespace CollaborationEngine.Tasks
{
    public class StepModel : Entity, ISerializable
    {
        ...
        #region Delegate
        public delegate void StepEventDelegate(StepModel sender, EventArgs eventArgs);
        public delegate void InstructionEventDelegate(StepModel sender, InstructionEventArgs eventArgs);
        #endregion
        ...
        public StepModel(UInt32 taskId, UInt32 order, String name)
        {
            _id = GenerateID();
            _taskId = taskId;
            _order = order;
        ...
        public void Deserialize(NetworkReader reader)
        {
            ...
            for (var i = 0; i < instructionCount; ++i)
                _instructions.Add(reader.ReadMessage<SceneObject.DataMessage>().Data);
        }
    }
}
