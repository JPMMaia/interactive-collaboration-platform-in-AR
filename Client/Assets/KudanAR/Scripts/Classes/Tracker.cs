...
namespace Kudan.AR
{
	public class Tracker : TrackerBase 
	{
		...
		/// <summary>
		/// Sets the marker extensibility status. Enabling this feature allows the tracker to extend markers by using the space surrounding the marker.
		/// This allows for detection and tracking at much greater distances, though this should only be used with markers that are stationary.
		/// </summary>
